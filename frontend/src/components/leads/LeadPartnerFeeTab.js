  ...
  if (denied) {
    return (
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
        ...
        <p className="mt-1">
          Nominal fee mitra hanya bisa dilihat peran yang berwenang (sales manager, marketing,
          keuangan, direksi). Anda tetap bisa melihat atribusi mitra pada tab Ringkasan.
        </p>
      </div>
    );
  }
      ...
      <div data-testid={CRMC.feeAttribution}
        ...
        {partner ? (
          ...
          <p className="mt-1 text-muted-foreground">
            Lead ini <b>tidak berasal dari mitra</b> (sumbernya {lead?.source || "tidak dicatat"}),
            jadi tidak ada hak fee yang lahir darinya. Ini keadaan yang benar, bukan data hilang.
          </p>
        )}
      </div>
